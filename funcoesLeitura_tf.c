...
void leCabDPREV(char *blocoLeitura, int *nmed, TF_DPREV **prev, TF_DRAM *ramos, TF_DBAR *barras, int numeroBarras, TF_GRAFO *grafo, int numeroRamos, double Sbase, long int ***numeroMedidas)
{
    ...
    for (size_t contador = 0; contador < (*nmed); contador++)
    {
        ...
        if (strcmp(medcod[1], "Pkm") == 0)
            (*prev)[contador].DMED.tipo = 0;
        else if (strcmp(medcod[1], "Qkm") == 0)
            (*prev)[contador].DMED.tipo = 1;
        else if (strcmp(medcod[1], "P") == 0)
            (*prev)[contador].DMED.tipo = 2;
        else if (strcmp(medcod[1], "Q") == 0)
            (*prev)[contador].DMED.tipo = 3;
        else if (strcmp(medcod[1], "V") == 0)
            (*prev)[contador].DMED.tipo = 4;
        else if (strcmp(medcod[1], "T") == 0)
            (*prev)[contador].DMED.tipo = 5;
        else if (strcmp(medcod[1], "Ikm") == 0)
            (*prev)[contador].DMED.tipo = 6;
        else if (strcmp(medcod[1], "ITkm") == 0)
            (*prev)[contador].DMED.tipo = 7;
        else if (strcmp(medcod[1], "I") == 0)
            (*prev)[contador].DMED.tipo = 8;
        else if (strcmp(medcod[1], "IT") == 0)
            (*prev)[contador].DMED.tipo = 9;
