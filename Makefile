all: fp 
    fp: main.o funcoesCalculoEletrico_tf.o funcoesFluxoVarredura_tf.o funcoesLeitura_tf.o funcoesModCarga_tf.o funcoesTopologia_tf.o funcoesMatematicas_tf.o funcoesAuxiliares.o funcoesLeituraDados.o funcoesRNP.o funcoesIntegracao_tf.o funcoesSetor.o funcoesInicializacao.o
	gcc -g -o fp main.o funcoesCalculoEletrico_tf.o funcoesFluxoVarredura_tf.o funcoesLeitura_tf.o funcoesModCarga_tf.o funcoesTopologia_tf.o funcoesMatematicas_tf.o funcoesAuxiliares.o funcoesLeituraDados.o funcoesRNP.o funcoesIntegracao_tf.o  funcoesSetor.o funcoesInicializacao.o -lm -lstdc++ -fopenmp
